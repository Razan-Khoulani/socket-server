...
const AVAILABLE_STATUSES = new Set([0, 4, 9, 10]);
const RIDE_START_STATUSES = new Set([5, 6, 7, 8]);
const REACHED_STATUSES = new Set([3]);
const ENROUTE_STATUSES = new Set([1, 2]);
...
const normalizeDashboardRideStatus = (rawStatus) => {
  ...
  if (AVAILABLE_STATUSES.has(safeStatus)) return 3;
  return 3;
};
